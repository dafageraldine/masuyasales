...
class OpenSOFragment: Fragment() {
    ...
    private fun selectSO(itemCount: Int){
        ...
        model.getSO(requireActivity(), user, itemCount, "Open", nobukti, cust, autho, status, item).observe(this, {
            ...
            run {
                ...
                i++
                binding.rvMain.recycledViewPool.clear()
                adapter.notifyDataSetChanged()*/
            }
        })
