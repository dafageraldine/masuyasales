...
class AllSOFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        listSO = ArrayList()
        adapter = AdapterRVSO(listSO, requireActivity())
    ...
    private fun selectSO(itemCount: Int){
        ...
        model.getSO(requireActivity(), user, itemCount, "All", nobukti, cust, autho, status, item).observe(this, {
    ...
    private class AdapterRVSO(val list_tampung: ArrayList<SalesOrder>, val activity: Activity): RecyclerView.Adapter <AdapterRVSO.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            when {
                list_tampung[position].statusorder.equals("OPEN", ignoreCase = true) -> {
                    holder.binding.viewStatus.setColorFilter(ContextCompat.getColor(activity, R.color.flatui_alizarin))
                }
                list_tampung[position].statusorder.equals("CLOSE", ignoreCase = true) -> {
                    holder.binding.viewStatus.setColorFilter(ContextCompat.getColor(activity, R.color.flatui_emerald))
                }
                else -> {
