...
class ClosedSOFragment: Fragment() {
    ...
    private fun selectSO(itemCount: Int){
        ...
        model.getSO(requireActivity(), user, itemCount, "Close", nobukti, cust, autho, status, item).observe(this, {
    ...
    private class AdapterSO(val list_tampung: ArrayList<SalesOrder>, val activity: Activity): RecyclerView.Adapter <AdapterSO.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.binding.cvMain.setOnClickListener { view: View? ->
            ...
            holder.binding.tvStatus.setOnClickListener { view: View? ->
