...
import com.yusuffahrudin.masuyamobileapp.databinding.DialogOtorisasiSoBinding
import com.yusuffahrudin.masuyamobileapp.databinding.DialogShowImageBinding
import com.yusuffahrudin.masuyamobileapp.databinding.DialogYesOrNoBinding
import com.yusuffahrudin.masuyamobileapp.databinding.FragmentSoHeaderBinding
...
class OtorisasiSOHeaderFragment: Fragment() {
            ...
            run {
                ...
                when {
                    binding.tvStatus.text == "OPEN" -> {
                        ...
                        if (listHeader[0].status!!.contains("!")) {
                            if (listHeader[0].otoODAR == "1" && listHeader[0].ARSL.equals("1")) {
                                //spv perlu atau tidak dikasih oto?
                                if (level.equals(kdlevelManager, true)) {
                                    binding.btnAccept.isEnabled = true
                                    binding.btnReject.isEnabled = true
                                } else if(level.equals(kdlevelSpvAR, true) || level.equals(kdlevelStaffAR, true)){
                                    binding.btnAccept.isEnabled = true
                                    binding.btnReject.isEnabled = true
                                ...
                                if (level.equals(kdlevelSpvAR, true) || level.equals(kdlevelStaffAR, true)) {
                                    binding.btnAccept.isEnabled = true
                                    binding.btnReject.isEnabled = true
                                    if  (listHeader[0].lamaKredit == "-1" && !listHeader[0].lunas) {
                                        binding.cbLunas.isEnabled = true
                                ...
                                } else if (level.equals(kdlevelSpv, true) || level.equals(kdlevelManager, true)){
                    ...
                    binding.tvStatus.text == "PENDING" -> {
                        ...
                        if (listHeader[0].status!!.contains("!")) {
                            if (listHeader[0].otoODAR == "1" && listHeader[0].ARSL.equals("1")) {
                                if (listHeader[0].otoODSL == "0" && level.equals(kdlevelManager, true) || level.equals(kdlevelSpv, true)) {
                                    binding.btnAccept.isEnabled = true
                                    binding.btnReject.isEnabled = true
                                } else {
                                    binding.btnAccept.visibility = View.GONE
                                ...
                                if (listHeader[0].otoODSL == "0" && level.equals(kdlevelManager, true)) {
                                    binding.btnAccept.isEnabled = true
                                    binding.btnReject.isEnabled = true
                                } else {
                                    binding.btnAccept.visibility = View.GONE
                ...
                (activity as DetailOtorisasiSOActivity).setView()
                binding.progressbar.visibility = View.GONE
            }
        })
    }
    ...
    private fun bottomOto(button: String){
        val dialogOto = Dialog(requireActivity())
        ...
        bindingDialog.actAlasanOto.setOnItemClickListener { _, _, position, _ ->
            ...
            if(binding.edtAlasanOdar.text.toString().equals("Kirim + retur")){
                if(!bindingDialog.actAlasanOto.adapter.getItem(position).toString().equals("Kirim + retur", false)){
                    DialogAlert("Teliti lagi alasan oto..!", "attention", requireActivity())
                    bindingDialog.actAlasanOto.setText("")
                }
            }
            if(binding.edtAlasanOdar.text.toString().equals("Pending 1 nota")){
                if(!bindingDialog.actAlasanOto.adapter.getItem(position).toString().equals("Pending 1 nota", false)){
                    DialogAlert("Teliti lagi alasan oto..!", "attention", requireActivity())
                    bindingDialog.actAlasanOto.setText("")
                }
            }
