...
class ButtonHelper(private val context: Context, private val text: String,
                   private val textSize: Int, private val imageResId: Int,
                   private val color: Int, private val listener: ButtonClickListener) {
    ...
    fun onDraw(c: Canvas, rectF: RectF, pos: Int) {
        ...
        if (imageResId == 0) {
            ...
            var iconMargin = (rectF.height() - d!!.intrinsicHeight) / 2
            //c.drawBitmap(bitmap, (rectF.left + rectF.right) / 2, (rectF.top + rectF.bottom) / 2, p)
            c.drawBitmap(bitmap, rectF.right - iconMargin - d.intrinsicWidth, rectF.top + iconMargin, p)
        }
