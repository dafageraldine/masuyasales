...
class WarehouseFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (listAks.isEmpty()){
            doAsync {
                ...
                uiThread {
                    ...
                    adapterMain = AdapterMain(requireActivity(), resources.getStringArray(R.array.gv_warehouse_text), resources.obtainTypedArray(R.array.gv_warehouse_img), listAks)
        ...
        binding.tvUser.text = user[SessionManager.kunci_email]?.toUpperCase()
        binding.tvKota.text = user[SessionManager.kdkota]?.toUpperCase()
